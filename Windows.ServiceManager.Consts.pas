...
const
  ...
  ErrorInfoArray: array[0..13] of TDSMErrorInfo =
    (
      (ErrorCode: SERVICELIST_NOT_ACTIVE; ExceptionClass: ENotActive; ErrorMessage: 'RebuildServicesList only works when Active.'),
      (ErrorCode: SERVICE_NOT_FOUND; ExceptionClass: EServiceNotFound; ErrorMessage: 'Service not found.'),
      (ErrorCode: OS_NOT_SUPPORTED; ExceptionClass: EOSNotSupported; ErrorMessage: 'This program only works on Windows NT, 2000, XP or later.'),
      ...
      (ErrorCode: SERVICE_CANNOT_PAUSE; ExceptionClass: EServiceCannotBePaused; ErrorMessage: 'Service cannot be paused.'),
      ...
      (ErrorCode: SERVICE_STARTTYPE_UNKNOWN; ExceptionClass: EServiceStartTypeUnknown; ErrorMessage: 'Service Start Type unknown.'),
